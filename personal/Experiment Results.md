...
3. 加入 CGAM 模块，稍稍好一点点，预计也不会特别好，毕竟在 SECOND 小目标检测上还没达到原论文结果

   ```txt
   |AP@50       |overall     |0-30m       |30-50m      |50m-inf     |
   |Vehicle     |77.81       |87.93       |73.40       |61.38       |
   |Pedestrian  |49.03       |58.32       |41.66       |23.88       |
   |Cyclist     |68.17       |78.76       |63.36       |45.27       |
   |mAP         |65.00       |75.00       |59.47       |43.51       |
   ```
