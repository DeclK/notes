...
在之前我已经对其中的内容有了大致的了解。不过由于一些事情搁置了，现在又有时间进行完整的整理。本次整理我希望借助 AI agent like claude code 的力量，完成更清晰的理解，最终发现了一个真相：

> You can outsourcing your thinking, but you can't outsourcing your understanding.

笔记还是得自己来写，AI 只能做一些辅助，因为最终需要理解这份文档的，是我自己
